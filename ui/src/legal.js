...
export const LEGAL = {
  appName: APP_NAME,
  operatorName: 'Lorik Bajrami',
  street: 'Paul-Fuss-Str. 2',
  postalCode: '24106',
  city: 'Kiel',
  country: 'Deutschland',
  email: 'contact@the-yields.app',
  phone: '',
  vatId: '',
  commercialRegister: '',
  responsibleForContent: 'Lorik Bajrami',
...
export function getLegalAddress(locale = 'de') {
  const useGerman = locale === 'de'
  return {
    street: LEGAL.street || (useGerman ? '[Strasse und Hausnummer]' : '[Street and house number]'),
    cityLine:
